...
public class Constants {
    ...
    public static final String COLORED_BLOCK_NAME = "colored_block";
    public static final String BOUNCESHROOM_BLOCK_NAME = "bounceshroom_block";
    public static final String BOUNCESHROOM_NAME = "bounceshroom";
    public static final String BOUNCESHROOM_BOOSTED_KEY = "boosted";
    public static final String ON_NAME = "on";
    public static final String OFF_NAME = "off";
    public static int LIGHT = 10;
    public static int COLORED_LIGHT = 15;
